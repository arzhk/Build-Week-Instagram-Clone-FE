  ...
  return (
    <Container className="mt-5 pt-5 px-5">
      <AppBar
        position="static"
        color="default"
        className={`d-flex justify-content-center align-items-center ${classes.appBar}`}
      >
        <Tabs
          value={value}
        ...
        >
          <Tab
            label={
              <>
                <GridOnIcon className={classes.tabIcons} /> POSTS
              </>
            }
            {...a11yProps(0)}
            className={classes.tabFonts}
          />
          <Tab
            label={
              <>
                <LiveTvIcon className={classes.tabIcons} /> IGTV
              </>
            }
            {...a11yProps(1)}
            className={classes.tabFonts}
          ...
          <Tab
            label={
              <>
                <BookmarkBorderIcon className={classes.tabIcons} /> SAVED
              </>
            }
            {...a11yProps(2)}
            className={classes.tabFonts}
          ...
          <Tab
            label={
              <>
                <AssignmentIndOutlinedIcon className={classes.tabIcons} /> TAGGED
              </>
            }
            {...a11yProps(3)}
            className={classes.tabFonts}
        ...
        <Container>
          <Row>
            {props.myPosts && props.myPosts.length > 0 ? (
              props.myPosts.map((post, index) => <SinglePost key={index} post={post} />)
            ) : (
              <p className="text-center w-100">No posts yet.</p>
            )}
          </Row>
        </Container>
      </TabPanel>
      <TabPanel value={value} index={1}>
        <Container className="d-flex justify-content-center align-items-center mt-5 flex-column text-center">
          <img src="https://img.icons8.com/ios/452/igtv.png" className={classes.igtvLogo} alt="igtv-logo" />
      ...
      <TabPanel value={value} index={3}>
        <Container className="d-flex justify-content-center align-items-center mt-5 flex-column text-center">
          <img
            src="https://cdn2.iconfinder.com/data/icons/instagram-ui/48/jee-72-512.png"
            className={classes.igtvLogo}
            alt="logo"
          />
